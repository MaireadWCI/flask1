import os
from flask import Flask  #importing our flask class, capital F indicates it is a class
...
def index():           #when we try to browse the root directory, as indicated by the "/", then Flask triggers the index function underneath and returns the "Hello wold" text
    return "Hello, World"
